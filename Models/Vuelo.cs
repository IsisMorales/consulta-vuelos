...
public class Vuelo {
   ...
   [BsonElement("aereopuerto_origen")]
   public string AereopuertoOrigen { get; set; } = string.Empty;
   ...
   [BsonElement("aereopuerto_destino")]
   public string AereopuertoDestino { get; set; } = string.Empty;
